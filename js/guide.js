(function($) {
  ...
  var guide = function() {
    var container,
      ...
      prevButton = $("<button/>").addClass("btn btn-default").html("Prev"),
      nextButton = $("<button/>").addClass("btn btn-default").html("Next"),
      arrow = $("<div/>").addClass("guideBubble-arrow").addClass("left"),
